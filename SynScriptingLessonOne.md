...
or, 
tell you to "move into your home Docs folder, make a scripts dir there and touch autoNmap.sh inside, then concatenate sharky into the new file and output the file contents to console for verification." You know enough about both ways!
