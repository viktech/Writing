...
192.168.1.136 metasploitable' 'sudo service network-manager restart'
now you can 'ping metasploitable' and 'nmap metasploitable' and it will auto resolve to the network IP.
